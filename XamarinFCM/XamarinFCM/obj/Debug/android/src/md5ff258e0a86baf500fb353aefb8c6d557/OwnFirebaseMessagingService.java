...
public class OwnFirebaseMessagingService
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XamarinFCM.OwnFirebaseMessagingService, XamarinFCM", OwnFirebaseMessagingService.class, __md_methods);
	}


	public OwnFirebaseMessagingService ()
	{
		super ();
		if (getClass () == OwnFirebaseMessagingService.class)
			mono.android.TypeManager.Activate ("XamarinFCM.OwnFirebaseMessagingService, XamarinFCM", "", this, new java.lang.Object[] {  });
	}
